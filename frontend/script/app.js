new Vue ({
	...
	methods: {
		...
		sendMessage: function() {
			...
			if(this.chats.indexOf(this.chats[this.partner]) != 0) {
				this.chats.unshift(this.chats[this.partner]);
				console.log(this.partner, this.chats[this.partner]);
				this.chats.splice(this.partner + 1, 1);
				this.partner = 0;
			}
		},
		inputColor: function() {
